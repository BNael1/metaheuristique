...
import bezier.projects.competitor.optipath.CMAESOptimizerExtendedBounds;
 ...
 *
 * Usage : java -cp "lib/*;bin" bezier.run.BenchmarkExtendedBounds [--seconds N] [--runs N]
 */
                ...
                for (int p = 0; p < problems.size (); p++)
                {
                    for (int r = 0; r < runs; r++)
                    {
                        ...
                        if (c == 0)
                            ...
                            optimizer = CMAESOptimizerExtendedBounds.of (
                                    problem, d, lb, ub, initMean, margins [c]);
