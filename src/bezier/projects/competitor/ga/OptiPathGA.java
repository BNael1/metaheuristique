...
/**
 * Projet compétiteur utilisant l'Algorithme Génétique (SBX + mutation polynomiale).
 */
public class OptiPathGA extends CompetitorProject
{
    private Optimizer optimizer;

    public OptiPathGA (Problem problem) throws InvalidProjectException
    {
        super (problem);
        this.addAuthor ("BENSAADI");
        this.addAuthor ("RAHALI");
        this.setMethodName ("OptiPath (GA SBX)");
    }
