...
/**
 * Entry point pour CMA-ES avec Stochastic Ranking (Runarsson & Yao).
 * Remplace les pénalités dures par un tri faisable/infaisable.
 */
public class OptiPathStochRank extends CompetitorProject
{
    private Optimizer optimizer;

    public OptiPathStochRank (Problem problem) throws InvalidProjectException
    {
        super (problem);
        this.addAuthor ("BENSAADI");
        this.addAuthor ("RAHALI");
        this.setMethodName ("OptiPath (StochRank-BIPOP-CMA-ES)");
    }
    ...
    public void initialization ()
    {
        ...
        optimizer = new CMAESStochRank (problem, d, lb, ub, initMean);
        optimizer.init ();
    }
