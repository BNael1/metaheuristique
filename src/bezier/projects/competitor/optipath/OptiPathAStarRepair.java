...
/**
 * Entry point pour BIPOP-CMA-ES avec réparation A* in-loop.
 * Maintient la cohérence topologique pendant l'évolution.
 */
public class OptiPathAStarRepair extends CompetitorProject
{
    private Optimizer optimizer;

    public OptiPathAStarRepair (Problem problem) throws InvalidProjectException
    {
        super (problem);
        this.addAuthor ("BENSAADI");
        this.addAuthor ("RAHALI");
        this.setMethodName ("OptiPath (A*Repair-BIPOP-CMA-ES)");
    }
    ...
    public void initialization ()
    {
        ...
        optimizer = new CMAESAStarRepair (problem, d, lb, ub, initMean, problem.getName ());
        optimizer.init ();
    }
