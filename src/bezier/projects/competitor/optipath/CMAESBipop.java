...
/**
 * BIPOP-CMA-ES : variante de CMA-ES ou les restarts alternent entre
 * un restart "large" (lambda double, sigma grand, exploration)
 * et un restart "petit" (lambda initial, sigma reduit, exploitation locale).
 *
 * Seul le mecanisme de restart differe de IPOP-CMA-ES.
 * Tout le reste (echantillonnage, mise a jour, eigendecomposition) est identique.
 */
public class CMAESBipop implements Optimizer
{
    // ===== References externes =====
    ...
    private int largeLambda;   // lambda courant pour les restarts "large"

    // ===== Constructeur =====
    public CMAESBipop (Problem problem, int d, double [] lb, double [] ub, double [] initMean)
    {
    ...
    // ================================================================
    //  INITIALISATION (identique a CMAESOptimizer)
    // ================================================================
    @Override
    public void init ()
    {
    ...
    // ================================================================
    //  OPTIMISATION LOCALE RAPIDE (identique)
    // ================================================================
    ...
    // ================================================================
    //  DETECTION DE STAGNATION (identique)
    // ================================================================
    ...
    // ================================================================
    //  RESTART BIPOP  (seule difference avec IPOP)
    // ================================================================
    private void restart ()
    {
        ...
        if (restartCount % 2 == 1)
        {
            // --- BIPOP restart "large" : exploration ---
            largeLambda = Math.min (largeLambda * 2, 512);
            newLambda = largeLambda;
            newSigma = sigma0;

            // Selection du mean : strategie diverse (identique a IPOP)
        ...
        {
            // --- BIPOP restart "petit" : exploitation locale ---
            newLambda = lambda0;
