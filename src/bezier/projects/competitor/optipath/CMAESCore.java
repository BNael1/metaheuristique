 ...
 *   - EvalWrapper       : ProgressivePenaltyEval
 *   - CovarianceUpdate  : StandardCovariance
 *   - ConstraintHandler : StandardConstraint
 *   - SamplingStrategy  : MirrorSampling
 *
...
public class CMAESCore implements Optimizer
{
    ...
    /**
     * Génération CMA-ES : O(d²) — avec rotation B et eigendécomposition.
     */
