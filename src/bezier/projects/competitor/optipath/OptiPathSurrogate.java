...
/**
 * Entry point pour Surrogate-Assisted BIPOP-CMA-ES avec RBF Pre-Screening.
 */
public class OptiPathSurrogate extends CompetitorProject
{
    private Optimizer optimizer;

    public OptiPathSurrogate (Problem problem) throws InvalidProjectException
    {
        super (problem);
        this.addAuthor ("BENSAADI");
        this.addAuthor ("RAHALI");
        this.setMethodName ("OptiPath (Surrogate BIPOP-CMA-ES)");
    }
    ...
    public void initialization ()
    {
        ...
        optimizer = new CMAESSurrogate (problem, d, lb, ub, initMean);
        optimizer.init ();
    }
