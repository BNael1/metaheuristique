...
/**
 * Entry point pour Adaptive BIPOP-CMA-ES avec Active Weights et Bandit Strategy.
 */
public class OptiPathAdaptive extends CompetitorProject
{
    private Optimizer optimizer;

    public OptiPathAdaptive (Problem problem) throws InvalidProjectException
    {
        super (problem);
        this.addAuthor ("BENSAADI");
        this.addAuthor ("RAHALI");
        this.setMethodName ("OptiPath (Adaptive BIPOP-CMA-ES)");
    }
    ...
    public void initialization ()
    {
        ...
        optimizer = new CMAESAdaptive (problem, d, lb, ub, initMean);
        optimizer.init ();
    }
