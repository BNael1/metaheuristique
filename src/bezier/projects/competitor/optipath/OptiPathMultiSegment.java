...
/**
 * Projet competiteur utilisant CMA-ES avec representation multi-segments de Bezier.
 */
public class OptiPathMultiSegment extends CompetitorProject
{
    private Optimizer optimizer;

    public OptiPathMultiSegment (Problem problem) throws InvalidProjectException
    {
        super (problem);
        this.addAuthor ("BENSAADI");
        this.addAuthor ("RAHALI");
        this.setMethodName ("OptiPath (CMA-ES MultiSegment)");
    }
    ...
    public void initialization ()
    {
        ...
        optimizer = new CMAESMultiSegment (problem, d, lb, ub, initMean);
        optimizer.init ();
    }
