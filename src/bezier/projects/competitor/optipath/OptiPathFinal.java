...
/**
 * Entry point pour la fusion finale : BIPOP + Active + Mirror + Surrogate + Covariance Memory.
 */
public class OptiPathFinal extends CompetitorProject
{
    ...
    public OptiPathFinal (Problem problem) throws InvalidProjectException
    {
        ...
        this.setMethodName ("OptiPath (Final Fusion BIPOP-CMA-ES)");
    }
    ...
    public void initialization ()
    {
        ...
        optimizer = new CMAESFinal (problem, d, lb, ub, initMean);
        optimizer.init ();
    }
