...
/**
 * Entry point pour Active IPOP-CMA-ES avec Mirror Sampling et Covariance Memory.
 */
public class OptiPathActive extends CompetitorProject
{
    private Optimizer optimizer;

    public OptiPathActive (Problem problem) throws InvalidProjectException
    {
        super (problem);
        this.addAuthor ("BENSAADI");
        this.addAuthor ("RAHALI");
        this.setMethodName ("OptiPath (Active CMA-ES)");
    }
    ...
    public void initialization ()
    {
        ...
        optimizer = new CMAESActive (problem, d, lb, ub, initMean);
        optimizer.init ();
    }
