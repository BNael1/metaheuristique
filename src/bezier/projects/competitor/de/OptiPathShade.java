...
/**
 * Projet competiteur utilisant SHADE (Success-History based Adaptive DE).
 */
public class OptiPathShade extends CompetitorProject
{
    private Optimizer optimizer;

    public OptiPathShade (Problem problem) throws InvalidProjectException
    {
        super (problem);
        this.addAuthor ("BENSAADI");
        this.addAuthor ("RAHALI");
        this.setMethodName ("OptiPath (DE SHADE)");
    }
    ...
    public void initialization ()
    {
        ...
        optimizer = new DEShade (problem, d, lb, ub, initMean);
        optimizer.init ();
    }
