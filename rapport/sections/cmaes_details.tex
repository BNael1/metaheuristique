...
Lorsque la convergence est détectée (écart de fitness dans la population $< 10^{-12}$, ou $\sigma$ effondré), l'algorithme effectue un \emph{restart}. Deux stratégies ont été implémentées :
