...
\emph{Discussion.}  Les pondérations $\alpha = \gamma = 100$ rendent les
collisions et les sorties de zone cent fois plus coûteuses par unité que la
longueur.  La courbure ($\beta = 1$) agit comme un régularisateur léger qui
favorise la fluidité sans dominer les autres termes.
